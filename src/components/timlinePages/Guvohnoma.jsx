...
const Guvohnoma = ({title, dateRange}) => {
  ...
  return (
    <div className="text-gray min-h-screen max-w-full mx-auto md:px-40 px-10 p-5 ">
      ...
      <div className="text-center mb-6">
        ...
        <h1 className="ml-4 text-2xl font-bold ">Haydovchilik Guvohnoma</h1>
        <div></div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6 flex items-center justify-between" onClick={handleOpenModal}>
        <h2 className="text-4xl font-medium mb-2">Haydovchilik Guvohnomasini Olish</h2>
        <img
          src={sugurta}
          alt="Buy Insurance"
          className="w-20"
