...
const TexnikKorik = ({title, dateRange}) => {
  ...
  return (
    <div className="text-gray min-h-screen max-w-full mx-auto md:px-40 px-10 p-5 relative ">
      {/* Header */}
      <div className="text-center mb-6">
        <div className="absolute top-4 left-4">
          <BackButton /> {/* Back button */}
        </div>
        <h1 className="ml-4 text-2xl font-bold ">Texnik Ko'rik</h1>
        <div></div>
      </div>
